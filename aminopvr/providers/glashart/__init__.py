    ...
    def _parseCodeJs( self, codeJsPath ):
        ...
        if content:
            ...
            regExp = {
                        ...
                        "CHANNEL_LIST_2":                 r"[A-Za-z]{1}=\s*\{\};\s*[A-Za-z]{1}.(?P<channel_url>[A-Za-z]{1,2})=\s*\"igmp:\/\/[0-9]{3}.[0-9]{1,3}.[0-9]{1,3}.[0-9]{1,3}:[0-9]{1,5}\";\s*[A-Za-z]{1}.[A-Za-z]{1,2}=\s*\[([^\]]*)\];\s*[A-Za-z]{1}.[A-Za-z]{1}=\s*1;\s*[A-Za-z]{1}.(?P<channel_url_hd>[A-Za-z]{1})=\s*1;",
                        ...
                        #                                   z                            [ b          ] =   { k                              :b          ,   c                                 :{ " default" :" Radio 3FM" } ,   q                                  :{ " default" :" Radio 3FM" } ,   j                            :" radio3" ,   m                            :" radio3" ,   s                              :" radio3fm.png" ,   t                              :" radio3fm.png" ,   o                              :" radio3fm.png" ,   u                             :1,   n                                   :a       ,d:[],e:[]};
                        ...
                        "CHANNEL_LIST_5":                 r"(?P<last_channel_number>[A-Za-z]{1,2})=\s*[A-Za-z]{1};[A-Za-z]{1}\[[A-Za-z]{1}\].(?P<next_channel_number>[A-Za-z]{1})=\s*[A-Za-z]{1};\s*for\([A-Za-z]{1}\[[A-Za-z]{1}\].[A-Za-z]{1}=\s*[A-Za-z]{1};[A-Za-z]{1}.length;\)[A-Za-z]{1}\[[A-Za-z]{1}.pop\(\)\]=[A-Za-z]{1};[A-Za-z]{1}.root",
                        #                                   window.clearInterval( e            ) ;p                               ( fb           ) ;var c            =   new r            ( o.Og                       ) ;c            .u            =d            ( ) ;s                               ( c            ) ;window.setTimeout( function( ) { ga           ( ) } ,50)
                        "PLAY_STREAM_ACTIONS":            r"window.clearInterval\([A-Za-z]{1,2}\);(?P<play_action_1>[A-Za-z]{1,2})\([A-Za-z]{1,2}\);var [A-Za-z]{1,2}=\s*new [A-Za-z]{1,2}\([A-Za-z]{1,2}.[A-Za-z]{1,2}\);[A-Za-z]{1,2}.[A-Za-z]{1,2}=[A-Za-z]{1,2}\(\);(?P<play_action_2>[A-Za-z]{1,2})\([A-Za-z]{1,2}\);window.setTimeout\(function\(\)\{[A-Za-z]{1,2}\(\)\},50\)",
                        #                                   function Ce                                  ( a                                 ,b            ) {N            .call( this) ;if( b            ===undefined) b            =   " " ;
                        "PLAY_STREAM_CLASS":              r"function (?P<play_stream_class>[A-Za-z]{1,2})\((?P<play_stream_url>[A-Za-z]{1,2}),[A-Za-z]{1,2}\){[A-Za-z]{1,2}.call\(this\);if\([A-Za-z]{1,2}===undefined\)[A-Za-z]{1,2}=\s*\"\";",
