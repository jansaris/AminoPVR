...
class ContentProvider( threading.Thread ):
    ...
    def _parseCodeJs( self, codeJsPath ):
        ...
        if content:
            ...
            parseOk     = True
            regExp = {
                        #                                   H                            [ b       ] =   { k                              :b          ,   c                                 :{ " default" :" Nederland 1" } ,   r                                  :{ " default" :" Nederland 1" } ,   l                            :" ned1" ,   n                            :" ned1" ,   u                              :" ned1.png" ,   v                              :" ned1.png" ,   p                              :" ned1.png" ,   o                                   :a          ,   e                               :[ ] ,   f                                 :[ ] ,   g                                 :[ ] } ;
                        ...
                        #                                   for( $              .tv.q            .push( b            ) ;e            .length;) E                                 [ e            .pop( ) ] =   b            ;
            ...
            if channelList1Match:
                ...
                channelListString = fileContent[channelList1Match.start():channelList1Match.start() + 2000]
