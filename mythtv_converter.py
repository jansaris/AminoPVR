...
def main():
    ...
    try:
        opts, args = getopt.getopt( sys.argv[1:], "dv", ['dryrun', 'verbose'] )  # @UnusedVariable
    except getopt.GetoptError:
        print "Available Options: --dryrun, --verbose"
        sys.exit()
    ...
    connMythTv = MySQLdb.connect( host = "192.168.1.253",
                                  user = "mythtv",
                                  passwd = "5hFsbRSo",
                                  db = "mythconverg",
                                  use_unicode = True )
